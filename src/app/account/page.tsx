...
export default function AccountPage() {
  return (
    <section className="shell account-page">
      <div className="page-heading"><span className="eyebrow">Shopping settings</span><h1>Your account</h1><p>Demonstration preferences for the Sunshine customer journey.</p></div>
